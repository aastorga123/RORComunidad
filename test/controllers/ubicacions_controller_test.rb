...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { cliente_id: @ubicacion.cliente_id, direccion_ubicacion: @ubicacion.direccion_ubicacion, nombreubicacion: @ubicacion.nombreubicacion, tipo: @ubicacion.tipo }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { cliente_id: @ubicacion.cliente_id, direccion_ubicacion: @ubicacion.direccion_ubicacion, nombreubicacion: @ubicacion.nombreubicacion, tipo: @ubicacion.tipo }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
