...
class PerfilsControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { descripcionperfil: @perfil.descripcionperfil, nombreperfil: @perfil.nombreperfil }
    end
  ...
  test "should update perfil" do
    patch :update, id: @perfil, perfil: { descripcionperfil: @perfil.descripcionperfil, nombreperfil: @perfil.nombreperfil }
    assert_redirected_to perfil_path(assigns(:perfil))
  end
