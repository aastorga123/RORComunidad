...
class UnidadsControllerTest < ActionController::TestCase
  ...
  test "should create unidad" do
    assert_difference('Unidad.count') do
      post :create, unidad: { calle_interna: @unidad.calle_interna, categoria_id: @unidad.categoria_id, numero_unidad: @unidad.numero_unidad, ubicacion_id: @unidad.ubicacion_id }
    end
  ...
  test "should update unidad" do
    patch :update, id: @unidad, unidad: { calle_interna: @unidad.calle_interna, categoria_id: @unidad.categoria_id, numero_unidad: @unidad.numero_unidad, ubicacion_id: @unidad.ubicacion_id }
    assert_redirected_to unidad_path(assigns(:unidad))
  end
